...
//constexpr size_t data_con_num = 8;
//
//// trials: the encrpt times, have to be divisible by threads_num and data_con_num
//constexpr size_t tasks_per_thread = 10000000;
//constexpr size_t trials = threads_num * data_con_num * tasks_per_thread;
//uint32_t input[threads_num][32]{};
//uint32_t output[threads_num][32]{};
//
//void task(int i) {
//	for (size_t ct = 0; ct < tasks_per_thread; ct++)
//	{
